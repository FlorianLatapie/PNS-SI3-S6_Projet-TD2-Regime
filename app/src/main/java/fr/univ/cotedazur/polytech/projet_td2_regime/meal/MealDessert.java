...
public class MealDessert extends Meal {
    ...
    public MealDessert(String name, int picture) {
        this.name = name;
    ...
    public MealDessert(String name, Bitmap picture, int preparationTime, int nbOfPeople, String ingredients, String preparation, int kcal, String author) {
        this.name = name;
    ...
    public MealDessert(String name, String imageLink, int preparationTime, int nbOfPeople, String ingredients, String preparation, int kcal, String author) {
        this.name = name;
    ...
    protected MealDessert(Parcel in) {
        name = in.readString();
        picture = in.readInt();
    }
    ...
    public static List<String> validate(MealDessert meal) {
