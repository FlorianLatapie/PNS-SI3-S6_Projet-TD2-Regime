...
public class MealStarter extends Meal {
    ...
    public MealStarter(String name, int picture) {
        this.name = name;
    ...
    public MealStarter(String name, Bitmap picture, int preparationTime, int nbOfPeople, String ingredients, String preparation, int kcal, String author) {
        this.name = name;
    ...
    public MealStarter(String name, String imageLink, int preparationTime, int nbOfPeople, String ingredients, String preparation, int kcal, String author) {
        this.name = name;
    ...
    protected MealStarter(Parcel in) {
        name = in.readString();
        picture = in.readInt();
    }
